...
class ReportController extends Controller
{
    ...
    public function tables()
    {
        ...
        foreach ($vals as $val => $key) {
            ...
            $sheet->getStyle('A' . $addRow . ':M' . $addRow)->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('D9D9D9');
            $sheet->getStyle('P' . $addRow . ':W' . $addRow)->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('D9D9D9');
            $sheet->getStyle('Z' . $addRow . ':AJ' . $addRow)->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('D9D9D9');
        ...
        $sheet->getStyle('I6:I' . $j)->getNumberFormat()->setFormatCode('[$$-en-US]* #,##0.00');
        $sheet->getStyle('L6:L' . $j)->getNumberFormat()->setFormatCode('[$$-en-US]* #,##0.00');
        $sheet->getStyle('K6:K' . $j)->getNumberFormat()->setFormatCode('[$$-en-US]* #,##0.00');
        $sheet->getStyle('I1:J1')->getNumberFormat()->setFormatCode('[$$-en-US]* #,##0.00');

        $sheet->getStyle('R6:R' . $j)->getNumberFormat()->setFormatCode('[$$-en-US]* #,##0.00');
        $sheet->getStyle('T6:T' . $j)->getNumberFormat()->setFormatCode('[$$-en-US]* #,##0.00');
        $sheet->getStyle('U6:U' . $j)->getNumberFormat()->setFormatCode('[$$-en-US]* #,##0.00');
        $sheet->getStyle('T1:U1')->getNumberFormat()->setFormatCode('[$$-en-US]* #,##0.00');

        // KENTUCKY
        $sheet->getStyle('AD6:AD' . $j)->getNumberFormat()->setFormatCode('[$$-en-US]* #,##0.00');
        $sheet->getStyle('AF6:AF' . $j)->getNumberFormat()->setFormatCode('[$$-en-US]* #,##0.00');
        $sheet->getStyle('AG6:AG' . $j)->getNumberFormat()->setFormatCode('[$$-en-US]* #,##0.00');
        $sheet->getStyle('AF1:AG1')->getNumberFormat()->setFormatCode('[$$-en-US]* #,##0.00');

        // $sheet->getStyle('L5:L'.$row_count)->getNumberFormat()->setFormatCode('[$$-en-US]* #,##0.00');
        $sheet->setCellValue(
            'J3',
            '=SUM(J6:J' . $j . ')'
        );
        // $sheet->getStyle('L4')->getNumberFormat()->setFormatCode(PhpOffice\PhpSpreadsheet\Style\NumberFormat::FORMAT_CURRENCY_USD_SIMPLE);
        $sheet->setCellValue(
            'J2',
            '=SUM(BD6:BD' . $j . ')'
        );
        ...
        $sheet->getStyle('A1:AH' . $j)->getAlignment()->setIndent(1);
        ...
        $sheet->setCellValue('K2', '=IF(J2>32000,"WEIGHT EXCEEDS LIMIT, PLEASE ASSIGN CUT ITEM","")');
        $sheet->getStyle('K2')->getAlignment()->setWrapText(true);

        $sheet->setCellValue('K3', '=IF(J2<32000,"WEIGHT UNDER LIMIT, PLEASE ASSIGN FILL ITEM","")');
        $sheet->getStyle('K3')->getAlignment()->setWrapText(true);

        $sheet->setCellValue('V2', '=IF(U2>32000,"WEIGHT EXCEEDS LIMIT, PLEASE ASSIGN CUT ITEM","")');
        $sheet->getStyle('V2')->getAlignment()->setWrapText(true);

        $sheet->setCellValue('V3', '=IF(U2<32000,"WEIGHT UNDER LIMIT, PLEASE ASSIGN FILL ITEM","")');
        $sheet->getStyle('V3')->getAlignment()->setWrapText(true);

        $sheet->setCellValue('AH2', '=IF(AG2>32000,"WEIGHT EXCEEDS LIMIT, PLEASE ASSIGN CUT ITEM","")');
        $sheet->getStyle('AH2')->getAlignment()->setWrapText(true);

        $sheet->setCellValue('AH3', '=IF(AG2<32000,"WEIGHT UNDER LIMIT, PLEASE ASSIGN FILL ITEM","")');
        $sheet->getStyle('AH3')->getAlignment()->setWrapText(true);
        ...
        $fileName = 'Zoe Report ' . date('Y-m-d') . '.xlsx';
