...
class ProcessReportControllerVernon extends Controller
{
    public function processReportVernonOnly($tableNameV)
    {
        ...
        foreach ($query as $row) {
            ...
            $sql3 = DB::connection('sqlsrv2')->table($tableNameV)
        ...
        $fileName = $tableNameV . date('Y-m-d') . '.xlsx';
